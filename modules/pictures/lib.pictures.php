...
function sc_module_mini_pictures($x) { eval(lib_rfs_get_globals());
    ...
    echo "(<a href=$RFS_SITE_URL/modules/pictures/pictures.php?action=random class=a_cat>Random Picture</a>)<br>";
    echo "(<a href=$RFS_SITE_URL/modules/pictures/pictures.php class=a_cat>More...</a>)";
	echo "</td></tr>";
