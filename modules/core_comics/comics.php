...
if($data->access==255){
    ...
    if($action=="editpagetemplate") {
        ...
        echo "<tr><td class=contenttd>Panels</td><td class=contenttd>";
        echo "<select name=panels>"; echo "<option>".$template['panels'];
        for($i=1;$i<9;$i++) echo "<option>$i";
        echo "</select>";
        echo "</td></tr>";
...
if($action=="viewcomic") { 
    ...
    if($npages>1) {
        if($page->page > 1)       echo "[<a href=$RFS_SITE_URL/modules/core_comics/comics.php?action=viewcomic&id=$id&pagenumber=1>Page 1</a>]";
        if($page->page > 1)       echo "[<a href=$RFS_SITE_URL/modules/core_comics/comics.php?action=viewcomic&id=$id&pagenumber=".($page->page-1).">Prev</a>]";
        if($page->page < $npages) echo "[<a href=$RFS_SITE_URL/modules/core_comics/comics.php?action=viewcomic&id=$id&pagenumber=".($page->page+1).">Next</a>]";
        if($page->page < $npages) echo "[<a href=$RFS_SITE_URL/modules/core_comics/comics.php?action=viewcomic&id=$id&pagenumber=$npages>Last Page</a>]";
    }
