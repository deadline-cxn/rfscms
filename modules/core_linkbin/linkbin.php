...
function linkbin_showaddform() {
    ...
    echo "<table border=0>\n";
    echo "<form enctype=application/x-www-form-URLencoded action=\"".$GLOBALS['RFS_SITE_URL']."/modules/core_linkbin/linkbin.php\" method=\"post\">\n";
...
function linkbin_action_addlink() { 
	linkbin_showaddform();
	linkbin_finish();
}
function linkbin_action_addlinkgo() { 
    ...
    linkbin_action_editlinkbin();
}
function linkbin_action_modifylinknow() {
...
function linkbin_action_addlink2bin() {
...
function linkbin_action_editlinkbin() {
