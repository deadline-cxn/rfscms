...
if($action=="delete_single"){
	...
	echo "<form action=$RFS_SITE_URL/modules/core_messages/messages.php method=post><input type=hidden name=id value=$id>";
...
if($action=="read"){
	...
	echo "[<a href=\"$RFS_SITE_URL/modules/core_messages/messages.php?action=new message&id=$msg->id\">New Message</a>] ";
	echo "</td><td>";

	echo "[<a href=$RFS_SITE_URL/modules/core_messages/messages.php?action=delete_single&id=$msg->id>Delete</a>] ";
	echo "</td><td>";

	echo "[<a href=\"$RFS_SITE_URL/modules/core_messages/messages.php?action=mark as unread&id=$msg->id\">Mark Unread</a>] ";
	echo "</td><td>";

	echo "[<a href=\"$RFS_SITE_URL/modules/core_messages/messages.php?action=reply&id=$msg->id\">Reply</a>] ";
	echo "</td><td>";

	echo "[<a href=$RFS_SITE_URL/modules/core_messages/messages.php>Inbox</a>] ";
	echo "</td><td>";
...
if(empty($action)) {
   ...
   ( `to` = '$data->name' or
	...
	if($numpmsg > 0) {
        ...
        echo "<form action=\"$RFS_SITE_URL/modules/core_messages/messages.php\" method=\"post\">";
