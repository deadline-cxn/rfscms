...
echo "<br><h1>$userdata->name's $site_name profile</h1>";

echo "<table border=0><tr>";
echo "<td width=10 valign=top><center><a href=\"$site_url/showprofile.php?user=$userdata->name\">\n";
sc_useravatar($userdata->name);
echo "</a></center></td>\n";

echo "<td>\n";
$gen=$userdata->gender;
echo "<img src=\"$site_url/images/sym_".$gen.".gif\" border=0 alt=\"$gen\" ><br>\n";

if($userdata->show_contact_info=="yes") {
    
    echo "<a href=\"".sc_getemailcode($userdata->email)."\"><font class=sc_email>$thisemail</font><img src=$site_url/images/email2.gif border=0 alt=\"E-Mail\" height=16></a><br>\n";
    echo "<a href=$userdata->webpage target=_blank><img src=$site_url/images/wp.gif  border=0 alt=\"Visit this person's website!\" height=16></a><br>\n";
...
echo "Personal Website: <a href=\"$site_url/link_out.php?link=$userdata->webpage\" target=\"_blank\">$userdata->webpage</a><br>";
echo "Favorite Website: <a href=\"$site_url/link_out.php?link=$userdata->website_fav\" target=\"_blank\">$userdata->website_fav</a><br>";
}
