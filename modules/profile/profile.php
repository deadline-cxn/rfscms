...
//{
  ...
  while($i<count($filelist))
  {
    ...
    if($filedata->worksafe=="yes")
        echo "<td align=center><img src=$RFS_SITE_URL/images/worksafe.gif border=0 align=center alt=\"Safe for work... Productivity Chart!\" title=\"Safe for work... Productivity Chart!\"></td>\n";
    else
        echo "<td align=center><img src=$RFS_SITE_URL/images/pinkslip.gif border=0 align=center alt=\"Not safe for work... Pink Slip!\" title=\"Not safe for work... Pink Slip!\"></td>\n";
