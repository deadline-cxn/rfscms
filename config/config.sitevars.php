...
$RFS_SITE_SLOGAN               = " (SITE VAR: SLOGAN) Powered by <a href=\"http://rfscms.org\">RFSCMS</a>";
if(isset($SERVER))
...
$RFS_SITE_FOOTER               = "";
$RFS_SITE_COPYRIGHT            = "<a href=\"http://rfscms.org/\" target=\"_blank\">Made with RFSCMS</a>";
$RFS_SITE_MENU_TOP_LOCATION    = "top";
$RFS_SITE_JOIN_FORM_CODE       = "<p>Your information will not be shared with anyone.</p><table border=0 cellspacing=0 cellpadding=0><form method=post action=\"$RFS_SITE_URL/login.php\"><input type=hidden name=action value=join_go><tr><td> User ID </td><td><input type=textbox  name=userid value=\"\">  </td></tr><tr><td> Email   </td><td><input type=textbox  name=email value=\"\">    </td></tr><tr><td>         </td><td> </td></tr><tr><td>         </td><td><input type=\"submit\" name=\"Register\" value=\"Register\"></td></tr></form></table>\n";
$RFS_SITE_LOGIN_FORM_CODE      = "<script src=\"\$RFS_SITE_URL/include/md5.js\"></script><form method=post action=\"\$RFS_SITE_URL/login.php\"><table align=right border=0 cellspacing=0 cellwidth=0 cellpadding=0 valign=middle><tr valign=middle><td align=right class=login><font class=slogan>Login</font><input type=hidden name=outpage value=\"\$thispage\"><input type=hidden name=action value=\"logingo\"></td><td class=login><input type=text name=userid size=10 class=\"b4text\"></td><td> <!--RTAG_FACEBOOK_LOGIN--> </td></tr><tr><td align=right class=login><font class=slogan>Password</font></td><td class=login><input type=password name=password size=10 class=\"b4text\"></td><input type=hidden name=outpage value='RFS_TAG_CANONICAL'><input type=hidden name=login value=fo_shnizzle><td valign=middle>\n <input type=\"submit\" name=\"Login\" value=\"Login\"></td></tr><tr><td></td><td></td><td>&nbsp;<a href=\$RFS_SITE_URL/login.php?action=join&outpage=\$PHP_SELF>Register</a></td></tr></table></form>";
...
$RFS_SITE_HEAD_OPEN         = "<HEAD><META NAME=\"ROBOTS\" CONTENT=\"INDEX,FOLLOW\"><META http-equiv=\"Content-Language\" content=\"en-us\"><META http-equiv=\"Content-Type\" content=\"text/html; charset=windows-1252\"><META name=\"GENERATOR\" content=\"RFS CMS\"><META name=\"ProgId\" content=\"RFS CMS\">\n";
