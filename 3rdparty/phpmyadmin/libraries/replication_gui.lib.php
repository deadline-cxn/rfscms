...
function PMA_replication_gui_master_addslaveuser()
{
    ...
    echo '>' . __('No Password') . '</option>'
        ...
        . '</div>'
        . '<div class="item">'
        . '<label for="button_lib_string_generate_password">'
        . '    ' . __('Generate Password') . ':'
        . '</label>'
        . '<span class="options">'
        . '    <input type="button" class="button" id="button_lib_string_generate_password" value="' . __('Generate') . '" onclick="suggestPassword(this.form)" />'
        . '</span>'
