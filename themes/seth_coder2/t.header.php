...
if(!empty($RFS_SITE_META)) lib_rfs_echo($RFS_SITE_META);
                ...
                tro("");
                    tco("toptd");
						...
						if ($RFS_THEME_TTF_TOP) {
							...
							if($timg) {
								echo "<div class=\"top_site_image\"><img src=\"$RFS_SITE_URL/$timg\" align=\"left\" border=\"0\"></div>";
							}
						}
						else {
